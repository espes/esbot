...
class Builder(object):
    def __init__(self, client):
        ...
        self.blockColours = {
            ...
            BLOCK_TREETRUNK: (86, 68, 41),
            #BLOCK_LEAVES: (45, 145, 32),
            #BLOCK_GLASS: (212, 255, 255),
            BLOCK_WHITEWOOLCLOTH: (229, 229, 229),
            BLOCK_SOLIDGOLDBLOCK: (223, 164, 43),
            BLOCK_SOLIDIRONBLOCK: (194, 194, 194),
            BLOCK_SOLIDDIAMONDBLOCK: (112, 222, 215),
            BLOCK_REDBRICKTILE: (205, 120, 95),
            #BLOCK_BOOKCASE: (66, 62, 37),
            BLOCK_MOSSCOVEREDCOBBLESTONE: (117, 133, 117),
            BLOCK_OBSIDIAN: (15, 15, 24),
            BLOCK_CLAY: (147, 153, 164),
            BLOCK_CHEST: (149, 127, 75),
            BLOCK_SNOWBLOCK: (246, 255, 255),
            BLOCK_CRAFTINGTABLE: (135, 77, 43),
            BLOCK_TNT: (219, 68, 26),
        }
